...
pub const Attacks = struct {
    ...
    fn generate_knight_masks() [8][64]Bitboard {
        ...
        const df = [8]i8{ 1, 1, -2, -2, -1, 2, 2, -1 };
        const dr = [8]i8{ 2, -2, 1, -1, 2, 1, -1, -2 };
...
test "knight plus" {
    try expectBitboard(
        ...
        \\........
        \\........
    , Attacks.knight_plus(Square.D5, DirectionPlus.All));
}
...
test "eyes vs rays" {
    try expectBitboard(
        ...
        \\........
        \\........
    , Attacks.ray_plus(Square.A1, Bitboard.C3.bitor(Bitboard.D4), DirectionPlus.Diagonal));
    ...
    try expectBitboard(
        ...
        \\.o......
        \\........
    , Attacks.eyes_plus(Square.A1, Bitboard.C3.bitor(Bitboard.D4), DirectionPlus.Diagonal));
}
